...
const PRODUCTS: Product[] = [
  ...
  { id: 10, name: "Samrat CMS", description: "CMS Granules - Bhumi Sudharak", weight: "50kg", image: "images/samrat-cms.jpg" },
  { id: 11, name: "Samrat Potash", description: "Potash Derived from Molasses (PDM)", weight: "50kg", image: "images/samrat-potash.png" },
