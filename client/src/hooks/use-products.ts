...
const PRODUCTS: Product[] = [
  ...
  { id: 2, name: "Samrat PROM", description: "Phosphate Rich Organic Manure", weight: "50kg", image: "images/prod-02.png" },
  { id: 10, name: "Samrat CMS", description: "CMS Granules - Bhumi Sudharak", weight: "50kg", image: "images/samrat-cms.png" },
  { id: 11, name: "Samrat Potash", description: "Potash Derived from Molasses (PDM)", weight: "50kg", image: "images/samrat-potash-clean.png" },
